...
mov cl, (end_of_copy - copy_second_part) / 2 + 1
...
mov byte al, 0xA7 ; set the low byte of al to A3 (A5 - 2) so when the loop overwrite itself it will be in the location of A5 (movsb opcode) 
mov bx, ax
